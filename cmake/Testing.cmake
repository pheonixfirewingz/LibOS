...
if(CMAKE_SYSTEM_NAME MATCHES WindowsStore)
    ...
    if(${BUILD_EXTENTIONS})
        target_link_libraries(Tests GTest::gtest_main libos libosextentions)
    else()
...
elseif(CMAKE_SYSTEM_NAME MATCHES Android)
    add_executable(Tests src/test/AndroidMain.cpp)
    flagsSetup(Tests)
    target_link_libraries(Tests libos android ${log-lib})
else()
