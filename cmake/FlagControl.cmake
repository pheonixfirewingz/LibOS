...
function(flagsSetup)
	if(CMAKE_BUILD_TYPE MATCHES Debug)
		if(CMAKE_CXX_COMPILER_ID MATCHES Clang)
			target_compile_options(${CMAKE_PROJECT_NAME} PRIVATE -W -Werror -Wall -Wextra -Weverything  -fno-common -Wdouble-promotion -Wshadow -Wpedantic -fno-exceptions  -O0 -g3)
			if(!${STATIC_BUILD})
				target_link_options(${CMAKE_PROJECT_NAME} PRIVATE -static-libstdc++)
			 endif()
		elseif(CMAKE_CXX_COMPILER_ID MATCHES GNU)
			 target_compile_options(${CMAKE_PROJECT_NAME} PRIVATE -W -Werror -Wall -Wextra -fno-common -Wdouble-promotion -Wshadow -Wpedantic -fno-exceptions  -O0 -g3)
			 if(!${STATIC_BUILD})
				target_link_options(${CMAKE_PROJECT_NAME} PRIVATE -static-libstdc++)
			 endif()
		elseif(MSVC)
		...
		if(CMAKE_CXX_COMPILER_ID MATCHES Clang)
			target_compile_options(${CMAKE_PROJECT_NAME} PRIVATE -W -Werror -Wall -Wextra -fno-common -Wdouble-promotion -Wshadow -Wpedantic -fno-exceptions -O2 -g0 -flto -finline-functions)
